...
## What's novel
- **No quote, no claim.** Whether Claude or the deterministic fallback writes a sentence, code checks its quote word-for-word against the fetched source, and anything unverified is dropped. Severity always comes from the authority (NHC, USGS PAGER, GDACS, WHO).
...
## Links
- Live demo (snapshot of a real run today): https://sentinel-chubb.vercel.app
- Deck: https://sentinel-chubb.vercel.app/deck/
- Repo: https://github.com/steven-industries/Stevens-hackathon (branch `claude/festive-thompson-0dehkl`)
- Demo video: [TODO]
